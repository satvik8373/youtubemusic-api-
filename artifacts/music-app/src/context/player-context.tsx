...
export function PlayerProvider({ children }: { children: React.ReactNode }) {
  ...
  const ensureApiLoaded = useCallback((videoId: string) => {
  ...
  return (
    ...
    >
      {children}
      <div className="absolute opacity-0 pointer-events-none w-px h-px overflow-hidden" style={{ left: -9999, top: -9999 }}>
